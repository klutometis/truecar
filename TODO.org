...
* TODO Statement
  ...
  become technical debt. Since any alternative to the GIL (e.g.
  fine-grained locks on mutable data structures) must be performant
  and backwards compatible, there is inertia against changing it.
